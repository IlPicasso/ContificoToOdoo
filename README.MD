...
replicando el esquema de autenticación del plugin oficial de WooCommerce y evitando
duplicar el valor en un encabezado `api-key` separado. Puedes utilizar el
