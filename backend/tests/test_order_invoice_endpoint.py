...
def test_get_contifico_client_dependency_includes_company_numeric_id(monkeypatch):
    ...
    monkeypatch.setattr(main.settings, "contifico_company_numeric_id", "987")
    ...
    assert created_clients[0].kwargs["company_numeric_id"] == "987"
